    ...
    <div id="login-container">
        ...
        <div class="child-login-container-right">
            ...
            <form method="post" action="login.validate.php">
                <p style="font-size: 30px;">Let's get started!</p>
            ...
            <p style="margin-top: 50px;
                      color: gray;
                      font-size: 12px">No account yet? <span style="font-weight: bold;">Register</span><span><a href="signup.php" style="margin-left: 3px; margin-bottom: 4px;">here</a></span></p>
        </div>
    </div>
</body>
</html>